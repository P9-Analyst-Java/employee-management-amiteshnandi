...
td{border:1px solid black; padding:5px; border-collapse: collapse;text-align: center; background-color:#d4e6f1 }th{width:1000px; border:1px solid black; background-color:#5499c7 }
